...
public class Configuration implements Iterable<Map.Entry<String,String>>,
  ...
  public String get(String name) {
    ...
    LOG.info("[para-get] get1 " + name + " " + result);
    return result;
  }
  ...
  public String get(String name, String defaultValue) {
    LOG.info("[para-get] get2 " + name + " " + defaultValue);
    String[] names = handleDeprecation(deprecationContext.get(), name);
    String result = null;
    for(String n : names) {
  ...
  public int getInt(String name, int defaultValue) {
    LOG.info("[para-get] getInt " + name + " " + defaultValue);
  ...
  public int[] getInts(String name) {
    LOG.info("[para-get] getInts " + name);
  ...
  public long getLong(String name, long defaultValue) {
    LOG.info("[para-get] getLong " + name + " " + defaultValue);
    String valueString = getTrimmed(name);
    if (valueString == null)
      return defaultValue;
    String hexString = getHexDigits(valueString);
  ...
  public long getLongBytes(String name, long defaultValue) {
    LOG.info("[para-get] getLongBytes " + name + " " + defaultValue);
    String valueString = getTrimmed(name);
    if (valueString == null)
      return defaultValue;
  ...
  private String getHexDigits(String value) {
    LOG.info("[para-get] getHexDigits " + value);
  ...
  public float getFloat(String name, float defaultValue) {
    LOG.info("[para-get] getFloat " + name + " " + defaultValue);
    String valueString = getTrimmed(name);
    if (valueString == null)
      return defaultValue;
  ...
  public double getDouble(String name, double defaultValue) {
    LOG.info("[para-get] getDouble " + name + " " + defaultValue);
    String valueString = getTrimmed(name);
    if (valueString == null)
      return defaultValue;
  ...
  public boolean getBoolean(String name, boolean defaultValue) {
    LOG.info("[para-get] getBoolean " + name + " " + defaultValue);
    String valueString = getTrimmed(name);
